...
- [x] **Deployment**: public scenario and comparison responses contain only aggregated metrics, explanations, observed competitor references, and optional aggregated model analysis. CSV files and survey rows have no public route. Vercel applies a same-origin content security policy plus `nosniff`, frame-denial, and referrer-policy headers. The stable public deployment is [lumen-g27.vercel.app](https://lumen-g27.vercel.app).
